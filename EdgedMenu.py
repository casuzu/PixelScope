...
low_threshold_slider = tk.Scale(root, from_=0, to=255, orient='horizontal', label="Lower Threshold",
                                command=edged_img_maker.edge_maker)
low_threshold_slider.set(low_threshold)

high_threshold = edged_img_maker.canny_high_threshold
high_threshold_slider = tk.Scale(root, from_=0, to=255, orient='horizontal', label="Upper Threshold",
                                 command=edged_img_maker.edge_maker)
